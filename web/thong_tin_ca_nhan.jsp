...
<style>
    ...
    .profile-page .side-head{
        display:flex;
        align-items:center;
        gap:10px;
        margin-bottom:12px;
    }
    .profile-page .side-avatar{
        width:36px;
        height:36px;
        border-radius:50%;
        object-fit:cover;
    }
    .profile-page .side-username{
        font-weight:700;
    }
    .profile-page .side-edit-hint{
        font-size:12px;
        color:#888;
    }
