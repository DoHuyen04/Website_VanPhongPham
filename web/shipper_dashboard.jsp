...
.container {
    max-width: 1200px;
        ...
        .btn-action { min-height:36px; padding:5px 12px; font-size:0.85rem; border-radius:5px; display:inline-flex; align-items:center; justify-content:center; }
        ...
        .btn-hoanhang { background: #FF6347; color:#fff; border:none; }
        .topmenu .nav-link { cursor:pointer; }
         .shipper-header {
            display: flex;
...
.bg-total { background-color: #6c757d; }       /* xám */
.bg-inprogress { background-color: #ffc107; }  /* vàng */
.bg-delivered { background-color: #28a745; }   /* xanh lá */
.bg-returned { background-color: #dc3545; }    /* đỏ */

        .dropdown-logout-content a:hover { background-color: #ddd; }
        .dropdown-logout:hover .dropdown-logout-content { display: block; cursor: pointer; }
    </style>
</head>
...
<ul class="nav nav-tabs mb-3">
 ...
 <div class="tab-content">
        ...
        <div class="mb-4">
            <h4>Top sản phẩm đánh giá cao</h4>
            <table class="table table-bordered table-hover bg-white">
                <thead class="table-light">
                <tr>
                    <th>STT</th>
                ...
                <%
                    stt = 1;
                    for(Map<String,Object> p : topRatedProducts){
                %>
                <tr>
                    <td><%= stt++ %></td>
                    <td><%= p.get("name") %></td>
