...
<%
    ...
    // danh sách ID sản phẩm mà user đã đánh giá
    ...
    <div class="order-container"><!-- ĐÃ ĐỔI TÊN Ở ĐÂY -->
        ...
        <%
            if (!lichSu.isEmpty()) {
                for (DonHang don : lichSu) {
                    List<DonHangChiTiet> chiTiet =
                        Optional.ofNullable(don.getChiTiet()).orElse(Collections.emptyList());

                    // danh sách sản phẩm CHƯA đánh giá trong đơn này
        ...
        <div class="order">
            ...
            <div class="summary-right">
                ...
                Thành tiền:
                <span class="price"><%= df.format(don.getTongTien() + phiVanChuyen) %></span>
            </div>
            ...
            <div class="action-row">
                ...
                <%
                        ...
                        if (!daDanhGiaHet) {
                %>
                <!-- Đơn đã giao, còn sản phẩm chưa đánh giá -->
                <button type="button"
                        class="btn review"
                ...
                %>
                <!-- Tất cả sản phẩm trong đơn đã đánh giá -->
                <button class="btn reviewed" disabled>Đã đánh giá</button>
                <%
                        }
                    } // end if tt
                %>
            ...
            <!-- select ẩn chứa danh sách SP chưa đánh giá trong đơn này -->
